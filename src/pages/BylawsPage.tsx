  ...
  return (
    <GovLayout title="Bylaws" subtitle="Official constitution of the Louisiana Chess Association">
      <div className="space-y-8">
        <DocumentSection category="bylaws" title="Bylaws documents" isAdmin={role === 'lca_admin'} />
        <DocumentSection category="amendments" title="Proposed amendments" isAdmin={role === 'lca_admin'} />
      </div>
    </GovLayout>
  )
}