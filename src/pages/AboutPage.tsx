  ...
  return (
    <GovLayout title="About LCA" subtitle="The Louisiana Chess Association">
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
        <div>
          <h2 className="mb-3 text-xl font-bold text-lca-navy">Who we are</h2>
        ...
        <div>
          <h2 className="mb-3 text-xl font-bold text-lca-navy">Our mission</h2>
        ...
        <div>
          <h2 className="mb-3 text-xl font-bold text-lca-navy">What we do</h2>
        ...
        <div>
          <h2 className="mb-3 text-xl font-bold text-lca-navy">USCF affiliation</h2>
        ...
        <div className="rounded-xl border-[3px] border-lca-gold bg-lca-navy p-6 text-white">
          ...
          <div className="mt-4 flex flex-wrap gap-3">
            <Link to="/membership" className="rounded-md bg-lca-gold px-4 py-2 text-sm font-semibold text-lca-navy hover:bg-lca-gold/90">Join LCA</Link>
